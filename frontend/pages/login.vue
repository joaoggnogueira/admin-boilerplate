...
<template>
    <div class="h-screen w-full flex-center flex-col bg-blue-bright-100">
        <h1 class="text-3xl mb-8"><span class="text-blue mr-2">Template</span><span class="text-blue-dark-100">CMS</span>
        </h1>
        <form @submit.prevent="submit" class="bg-white rounded-lg py-20 px-12 max-w-lg w-full grid grid-cols-2 gap-y-8">
